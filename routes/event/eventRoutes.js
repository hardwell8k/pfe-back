...
const {getUPcomingEvents,addEvent, updateEvent, deleteEvent,getEventsHistory,getRestOfEventsHistoryData,getUPcomingEventsPageData,getFirstPageData,getUPcomingEventsFirstPage} = require("../../controllers/event/eventController");
