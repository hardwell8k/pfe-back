...
const {getUPcomingEvents,addEvent, updateEvent, deleteEvent,getEventsHistory,getRestOfEventsHistoryData,getUPcomingEventsPageData,getFirstPageData} = require("../../controllers/event/eventController");
